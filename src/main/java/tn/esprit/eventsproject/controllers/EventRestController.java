...
public class EventRestController {
    ...
    @PostMapping("/addPart")
    public Participant addParticipant(@RequestParam Participant participant){
        return eventServices.addParticipant(participant);
    }
    @PostMapping("/addEvent/{id}")
    public Event addEventPart(@RequestParam Event event, @PathVariable("id") int idPart){
    ...
    public Logistics addAffectLog(@RequestParam Logistics logistics,@PathVariable("description") String descriptionEvent){
